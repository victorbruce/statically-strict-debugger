...
describe("Verifying the functionality of the Light class", () => {
    ...
    test("Activate the light by setting its attributes to ON.", () => {
        ...
        expect(imgElement.getAttribute("data-lightOn")).toBe("./assets/svgs/light_bulb_off.svg");
    });
    test("Deactivate the light by setting its attributes to OFF.", () => {
        const imgElement = document.createElement("img");
        light.lightSwitchOff(imgElement);
        expect(imgElement.getAttribute("src")).toBe("./assets/svgs/light_bulb_off.svg");
        expect(imgElement.getAttribute("data-lightOn")).toBe("./assets/svgs/light_bulb.svg");
    });
});
